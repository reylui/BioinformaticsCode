...
def main():
    ...
    # Build all the jobs
    jobs = [(feat_idx, X_drug, y_drug, elastic_model, features, ccle_features, model_weights) for feat_idx in
            range(args.min_feature, min(args.max_feature + 1, len(ccle_features)))]
